...
\begin{frame}{Repositories}
\begin{itemize}
TODOOOOO: Bild mit klassischer Schichtung
\end{itemize}
\end{frame}
...
\begin{frame}{Repositories}
\begin{itemize}
TODOOOOO: Bild mit Innen-Außen-Architektur.
\end{itemize}
\end{frame}
...
\item[N] Moment mal - ich glaub, jetzt sehe ich wo das hinführt. Das hilft mir ja auch beim Testen. Auch hier baue ich mir ja einen Teil der Anwendung zusammen. Da habe ich jetzt dann die Wahl, ob ich ein "echtes" also DB-gebundenes Repository verwende, oder einfach nur einen Mock oder Stub, der die Daten in einer Collection hält. Das ist ja wirklich elegant. Ich habe gesehen, hier gibt es noch andere Adapter. Wozu sind die da?
