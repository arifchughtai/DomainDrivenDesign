...
\includegraphics[width=.5\framewidth]{pics/evans.pdf}
\includegraphics[width=.5\framewidth]{pics/vernon.pdf}
\end{frame}
...
\item[J] Nein, da sollte man schon selbst etwas implementieren, Objektidentität passt meistens nicht genau. Insbesondere wenn man mit einer Datenbank arbeitet und immer wieder neue Instanzen einer Entität bekommt. Auf der Datenbank haben die Objekte ja auch eine Id. Die ist oft ein sinnvoller Kandidat für eine Identität. 
...
\item Achtung vor blutleerem Modell
\end{itemize}
\end{frame}
...
\item[N] Das verstehe ich. Jede Methode, bei der ich nicht weiß, wo sie hinkommt, packe ich einfach erstmal in einen Service. Das ist ja einfach.
